...
export function AdminOrders() {
  const ordersList = [
    { id: "ord-88392", customerId: "usr-cli-001", customerEmail: "cliente@cloudshop.test", date: "25 Jul 2026", total: 1574.97, status: "CREADO", storeId: "store-001" },
    { id: "ord-88301", customerId: "usr-cli-001", customerEmail: "cliente@cloudshop.test", date: "18 Jul 2026", total: 249.50, status: "COMPLETADO", storeId: "store-002" },
