...
export function CatalogoPage() {
  ...
  const products = [
    { id: "PROD-001", storeId: "store-001", name: "Laptop Gamer Ultra 16GB", price: 1299.99, storeName: "Tienda Tech Central", rating: 4.8, category: "Electrónica" },
    { id: "PROD-002", storeId: "store-001", name: "Audífonos Bluetooth Noise Cancelling", price: 129.99, storeName: "Tienda Tech Central", rating: 4.9, category: "Electrónica" },
    { id: "PROD-003", storeId: "store-002", name: "Silla Ergonómica de Oficina", price: 249.50, storeName: "Hogar & Confort", rating: 4.6, category: "Hogar" },
    { id: "PROD-004", storeId: "store-003", name: "Zapatillas Deportivas Air Run", price: 89.90, storeName: "Sporting Goods", rating: 4.7, category: "Deportes" },
  ]
          ...
          >
            <div>
              <div className="h-48 bg-muted/60 relative flex items-center justify-center p-4">
                <div className="h-20 w-20 rounded-2xl bg-primary/10 text-primary flex items-center justify-center font-extrabold text-lg group-hover:scale-110 transition-transform">
                  CS
                </div>
