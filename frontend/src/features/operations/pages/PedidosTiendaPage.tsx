...
export function PedidosTiendaPage() {
  ...
  const storeOrders = [
    { id: "ord-88392", customerId: "usr-003", customerEmail: "maria@gmail.com", date: "25 Jul 2026", total: 1574.97, status: "CREADO" },
    { id: "ord-88301", customerId: "usr-003", customerEmail: "maria@gmail.com", date: "18 Jul 2026", total: 249.50, status: "COMPLETADO" },
  ]
